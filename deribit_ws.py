...
class WS_Client(object):
    ...
    def edit(self, order_id, amount, price):
        options = {"order_id": order_id, "amount": amount, "price": price}
    ...
    def get_open_orders_by_instrument(self, instrument_name, type="all"):
        options = {
            "instrument_name": instrument_name,
            "type": type,
        }
        self.json["method"] = "private/get_open_orders_by_instrument"
        self.json["params"] = options
        return self.loop(self.private_api, self.json)
